       ...
       <?php require("include/nav.php") ?>
        <div class="container-fluid">
            <div class="row" >
                ...
                <div class="col-md-9">
                    <h1 class="head animated fadeInUp"><i class="fa fa-user "></i> Edit User <small>Edit User Detail</small></h1>
                    <hr/>
                    <ul class="breadcrumb">
                    ...
                    <?php
                        if(isset($_POST['submit'])){
                            ...
                            if(empty($first_name) or empty($last_name)  or empty($image)){
                                ...
                                $update_query="UPDATE `users` SET `first_name` = '$first_name', `last_name` = '$last_name', `image` = '$image',  `role` = '$role', `detail` = '$detail'";
                                if(isset($password)){
